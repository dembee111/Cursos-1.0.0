...
gulp.task("copy:customJS", function () {
  return gulp.src("src/assets/js/exam.js").pipe(gulp.dest("dist/assets/js"));
});

gulp.task("copy:courseJS", function () {
  return gulp
    .src("src/assets/js/add-course.js")
